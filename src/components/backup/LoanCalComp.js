...
const LoanCalComp = ({ getAmount, getDuration, getMonthly }) => {
    ...
    let totalInterest = numIntialPeriod * 6;
    let calculateIntersetAmout = numIntialAmount * (totalInterest / 100);

    let totalAmountWithInt = numIntialAmount + calculateIntersetAmout;
    let monthlyPayment = (totalAmountWithInt / numIntialPeriod).toFixed(2);
